        ...
        <div className="cart-container">
            <header className="xenon-header">
                      ...
                      <nav className="header-nav" style={{marginRight:0}}>
                          ...
                          <Link to="/" className="cart-btn" style={{width: 101,
    paddingRight: 38,
    paddingLeft: 38}}>На главную</Link>
                      </nav>
                  </header>
        ...
        {cart.items.map(item => (
          <div key={item.id} className="cart-item">
            ...
            <div className="cart-item-quantity">
              ...
              <button onClick={() => updateQuantity(item.id, item.quantity + 1)}disabled={item.quantity >= 50}>+</button>
            </div>
